...
const BootstrapButton = styled(Button)({
  ...
  const card=( <Card sx={{ maxWidth: 1300 }}>
   ...
   <CardContent sx={{marginLeft:1}}>
    ...
    <BootstrapButton sx={{marginLeft:4,letterSpacing:3}}  variant="contained" disableRipple>SHOP WOMEN </BootstrapButton>
...
export default function Home() {
  return (
     ...
     <>
      ...
      <Typography variant="h4" sx={{marginLeft:45,paddingTop:14,paddingBottom:7}}>Shop By Category</Typography>
