  ...
  return (
    <>
      <Card sx={{ maxWidth: 1355 }}>
        <CardMedia sx={{ height: 500 }} image="bgimg.png" title="Shopping page">
          <CardContent sx={{ marginLeft: 1 }}>
            <Typography
              variant="h3"
              component="div"
              sx={{ color: "white", marginTop: 30, padding: 1 }}
            >
            ...
            <Typography
              ...
              sx={{ color: "white", fontSize: 17, padding: 1 }}
            >
              Super Packable. Versatile. And All-Day (And Night) Adventure
              Ready.
            </Typography>
          </CardContent>
          <Stack spacing={2} direction="row">
            <BootstrapButton sx={{ marginLeft: 4, letterSpacing: 3 }}variant="contained"
      ...
      <Typography
        variant="h4"
        sx={{ marginLeft: 65, paddingTop: 3, paddingBottom: 7 }}
      >
        Shop By Category
      </Typography>
