...
import { AddTOCartStart, MensCartStart, loadUsersStart, loadUsersStart2, setProducts, showUserResClean } from '../Redux/action';
...
console.log(users)
    ...
    useEffect(() => {
        console.log("mens data",response);
      if (response === "Created") {
                                ...
                                <Grid key={index} user>
                                    <Card sx={{ width: 300 }}>
                                        ...
                                        <CardActions disableSpacing>
                                                ...
                                                <OneButton aria-label="add to favorites" onClick={() => dispatch(MensCartStart(user))}>
